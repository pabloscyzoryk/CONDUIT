...
export const ZNACZENIE_ZERA: Partial<Record<SettingKey, ZnaczenieZera>> = {
  ...
  profit_budget_arm_pct: "wylaczone",
  ...
  day_trail_stop_pct: "wylaczone",
  day_trail_arm_pct: "wylaczone",
...
export const SETTINGS_SCHEMA: GroupDef[] = [
  ...
  /* ================= WEJSCIA ================= */
  {
    ...
    fields: [
      ...
      {
        key: "explicit_pending_until_cancel",
        label: "SYGNAŁY LIMIT/STOP WAŻNE DO ANULOWANIA",
        hint: "Jawny sygnał LIMIT/STOP nie wygasa przez wiek, TTL, TP ani RISK FREE. Odpowiedź CANCEL / NO LONGER VALID wycofuje sygnał. Ochrona rachunku może nadal zdjąć ekspozycję; nie oznacza to anulowania źródła ani obietnicy automatycznego odtworzenia zleceń. Nie dotyczy sygnału rynkowego, dla którego bot sam tworzy siatkę limitów.",
        type: "bool",
      },
      {
      ...
      },
      {
        ...
        hint: "Dla zwykłych sygnałów przesuwa wygasanie wejść z TP1 na TP2. Jawny LIMIT/STOP z ważnością do anulowania nie wygasa po TP.",
        type: "bool",
      },
      {
        key: "custom_entry",
        label: "CUSTOM ENTRY LEVEL",
        hint: "Własne cenowe przesunięcia granic strefy. Włączenie wyłącza konkurencyjny tryb offsetów według kierunku.",
        type: "bool",
      },
      ...
      { key: "entry_low_offset", label: "dolna granica ±", type: "num", step: 0.1, unit: "$", when: (s) => s.custom_entry },
      {
        ...
        hint: "BUY: lepsza cena jest niżej. SELL: wyżej. Włączenie wyłącza konkurencyjny tryb cenowych przesunięć CUSTOM ENTRY.",
        type: "bool",
      },
      {
      ...
      },
      {
        ...
        hint: "Wygasza czekający sygnał bez otwartej pozycji po X minutach. 0 wyłącza próg. Jawny LIMIT/STOP z ważnością do anulowania jest wyłączony z tej reguły.",
        type: "num",
        step: 1,
        unit: "min",
      },
  ...
  /* ================= SIATKA ================= */
  {
    ...
    fields: [
      ...
      },
      {
        key: "pending_ttl_h",
        label: "TTL PENDINGÓW",
        hint: "Usuwa niewypełnione zlecenia po X godzinach; 0 wyłącza TTL. Nie dotyczy jawnych LIMIT/STOP z włączoną ważnością do anulowania. Ochrona ryzyka nadal działa.",
        type: "num",
        step: 1,
        unit: "h",
      },
    ...
    fields: [
      {
        ...
        hint: "Każda pozycja dostaje najkorzystniejszy TP. Włączenie wyłącza SCALE-OUT i tryb oficjalny. Trailing zależy od osobnych ustawień.",
        type: "bool",
      },
      {
        key: "scale_out",
        label: "SCALE-OUT",
        hint: "Zamyka procent pozycji na kolejnych TP. Włączenie wyłącza ALL RUNNERS i tryb oficjalny.",
        type: "bool",
      },
    ...
    fields: [
      {
        ...
        hint: "Po przekroczeniu progu zysku przesuwa SL według wybranego trybu. Trailing rozdzielony bank + runner ma osobny przełącznik. Zlecenie ochronne nie gwarantuje ceny wykonania ani zysku netto.",
        type: "bool",
        warn: (s) =>
      ...
      },
      {
        ...
        options: [
          ...
          { value: "atr", label: "ATR — luka według zmienności" },
          { value: "chandelier", label: "Chandelier — ekstremum i ATR" },
        ],
        when: (s) => s.runner_trail,
      },
      {
      ...
      },
      {
        ...
        hint: "95 = docelowy SL zachowuje 95% najwyższego zysku cenowego pozycji. Koszty i wykonanie zlecenia wpływają na wynik netto.",
        type: "num",
        min: 1,
        max: 99,
        step: 5,
      ...
      {
        key: "trail_adaptive_enabled",
        label: "ADAPTACYJNY TRAILING WG JAKOŚCI RUCHU",
        hint: "Mierzy wyłącznie przeszłe ticki. Czysty ruch zgodny poszerza lukę runnera, chaotyczny ją normalizuje, a szybkie odwrócenie zaciska. Działa tylko z Gap/ATR/Chandelier i nigdy nie cofa już ustawionego SL.",
        type: "bool",
      },
      {
        key: "trail_adaptive_runners_only",
        label: "tylko runnery",
        hint: "Włączone: zwykłe pozycje zachowują swój trailing, a adaptacja dotyczy wyłącznie ogona zysku.",
        type: "bool",
        when: (s) => s.trail_adaptive_enabled,
      },
      { key: "trail_adaptive_window_s", label: "okno jakości ruchu", type: "num", min: 10, step: 5, unit: "s", when: (s) => s.trail_adaptive_enabled },
      { key: "trail_adaptive_min_samples", label: "minimum próbek", type: "num", min: 2, step: 1, when: (s) => s.trail_adaptive_enabled },
      {
        key: "trail_adaptive_trend_er",
        label: "próg czystego trendu (ER)",
        hint: "0..1; 1 oznacza ruch bez żadnego cofnięcia.",
        type: "num", min: 0, max: 1, step: 0.05, when: (s) => s.trail_adaptive_enabled,
      },
      { key: "trail_adaptive_reversal_er", label: "próg czystego odwrócenia (ER)", type: "num", min: 0, max: 1, step: 0.05, when: (s) => s.trail_adaptive_enabled },
      { key: "trail_adaptive_trend_gap_mult", label: "mnożnik luki: dobry trend", type: "num", min: 0, step: 0.05, unit: "×", when: (s) => s.trail_adaptive_enabled },
      { key: "trail_adaptive_chop_gap_mult", label: "mnożnik luki: szum", type: "num", min: 0, step: 0.05, unit: "×", when: (s) => s.trail_adaptive_enabled },
      { key: "trail_adaptive_reversal_gap_mult", label: "mnożnik luki: odwrócenie", type: "num", min: 0, step: 0.05, unit: "×", when: (s) => s.trail_adaptive_enabled },
      { key: "trail_adaptive_fast_vol_s", label: "krótkie okno prędkości", type: "num", min: 5, step: 5, unit: "s", when: (s) => s.trail_adaptive_enabled },
      { key: "trail_adaptive_slow_vol_s", label: "długie okno prędkości", type: "num", min: 10, step: 10, unit: "s", when: (s) => s.trail_adaptive_enabled },
      { key: "trail_adaptive_vol_ratio", label: "próg ekspansji prędkości", type: "num", min: 0, step: 0.1, unit: "×", when: (s) => s.trail_adaptive_enabled },
      { key: "trail_adaptive_vol_favorable_mult", label: "ekspansja zgodna: mnożnik", type: "num", min: 0, step: 0.05, unit: "×", when: (s) => s.trail_adaptive_enabled },
      { key: "trail_adaptive_vol_adverse_mult", label: "ekspansja przeciwna: mnożnik", type: "num", min: 0, step: 0.05, unit: "×", when: (s) => s.trail_adaptive_enabled },
      { key: "trail_adaptive_min_peak", label: "adaptuj dopiero od szczytu", type: "num", min: 0, step: 0.25, unit: "$", when: (s) => s.trail_adaptive_enabled },
      { key: "trail_adaptive_min_gap", label: "minimalna skuteczna luka", hint: "0 = bez dolnej klamry.", type: "num", min: 0, step: 0.25, unit: "$", when: (s) => s.trail_adaptive_enabled },
      { key: "trail_adaptive_max_gap", label: "maksymalna skuteczna luka", hint: "0 = bez górnej klamry.", type: "num", min: 0, step: 0.25, unit: "$", when: (s) => s.trail_adaptive_enabled },
      {
    ...
    fields: [
      {
        key: "be_lock",
        label: "BE-LOCK",
        hint: "Po osiągnięciu progu zysku bot przesuwa SL do poziomu wejścia z ustawioną blokadą. Koszty i cena wykonania wpływają na wynik netto.",
        type: "bool",
      },
    ...
    fields: [
      {
        ...
        hint: "Używa osobnego harmonogramu procentów lub liczby pozycji. Włączenie wyłącza ALL RUNNERS i SCALE-OUT.",
        type: "bool",
      },
  ...
  /* ================= OCHRONA KAPITALU ================= */
  {
    ...
    fields: [
      ...
      },
      {
        ...
        hint: "Odrzuca stare sygnały wejścia. Nie obejmuje komunikatów zarządzających, edycji istniejących koszyków ani jawnych LIMIT/STOP z włączoną ważnością do anulowania. 0 wyłącza bramkę.",
        type: "num",
        min: 0,
        max: 240,
        step: 1,
      ...
      },
      {
        ...
        hint: "Po osiągnięciu celu dziennego zamknij pozycje i anuluj zlecenia oczekujące.",
        type: "bool",
      ...
      {
        key: "day_trail_basis",
        label: "Podstawa stopu dnia",
        type: "select",
        options: [
          { value: "equity_peak", label: "Kapitał na szczycie · dotychczasowy" },
          { value: "profit_peak", label: "Zysk dnia na szczycie" },
        ],
        hint: "Kapitał: spadek jest procentem szczytu equity dnia. Zysk: spadek jest procentem dodatniego zysku dnia na szczycie; przed dodatnim zyskiem stop pozostaje nieuzbrojony. Wybór podstawy nie włącza stopu — ustaw próg poniżej.",
      },
      {
        key: "day_trail_stop_pct", label: "Stop dnia: dopuszczalny spadek", type: "num", min: 0, max: 100, step: 1, unit: "%",
        hint: "Odległość od szczytu liczona według wybranej podstawy. 0 wyłącza procentowy stop dnia. Np. zysk na szczycie $100 i próg 30%: wyjście po oddaniu $30 tego zysku.",
      },
      {
        key: "day_trail_arm_pct", label: "Stop dnia: zysk do uzbrojenia", type: "num", min: 0, step: 1, unit: "%",
        hint: "Minimalny zysk od kapitału początku dnia, zanim stop procentowy może zadziałać. 0 = bez dodatkowego progu uzbrojenia; podstawa „zysk dnia” nadal wymaga dodatniego zysku.",
        when: s => s.day_trail_stop_pct > 0,
      },
      {
      ...
      },
      {
        ...
        hint: "Codziennie o tej godzinie zamknij wszystko i anuluj pendingi. Zegar wybierasz polem „zegar brokera zamiast lokalnego”. 0 = wyłączone.",
        type: "num",
        min: 0,
        max: 23,
        step: 1,
  ...
  /* ================= AUDYT ================= */
  {
    ...
    fields: [
      ...
      },
      {
        key: "lot_min",
        label: "MINIMALNY LOT",
        hint: "Minimum strategii, odrębne od minimum i kroku brokera. Kontrakt V2 wymaga dodatniej wartości; nie zaokrągla niedostępnego wolumenu w górę.",
        type: "num",
        min: 0.01,
        step: 0.01,
        unit: "lot",
      },
      {
        ...
        hint: "Sufit pojedynczego zlecenia. 0 usuwa tylko ten limit strategii; nie usuwa limitu brokera, ryzyka ani marginesu. Dodatkowy limit z kapitału ustawisz przez lot_max_z_salda.",
        type: "num",
        min: 0,
        step: 1,
        unit: "lot",
  ...
  /* ================= SIATKA I PENDINGI — SZCZEGOLY ================= */
  {
    ...
    fields: [
      ...
      },
      {
        ...
        hint: "Po celu koszyka usuwa niewypełnione limity. Jawny LIMIT/STOP z ważnością do anulowania jest wyłączony z tej reguły; botowa siatka zwykłego sygnału nadal jej podlega.",
        type: "bool",
      },
      {
  ...
  {
    id: "engine_entries",
    title: "Wejścia — pełna geometria",
    desc: "Zaawansowane osie presetu. Edycja dotyczy wybranego presetu; pokaż pola zależne lub użyj wyszukiwania.",
    icon: "sliders",
    category: "management",
    zakres: "preset",
    fields: [
      { key: "drop_unplaceable_levels", label: "Porzuć niewykonalne szczeble", type: "bool" },
      { key: "enforce_position_limit_on_fill", label: "Sprawdzaj limit pozycji przy fillu", type: "bool" },
      { key: "entry_jeden_na_glebokiej", label: "Jedno wejście na głębokiej krawędzi", type: "bool" },
      { key: "entry_krzywa_kotwica", label: "Kotwica krzywej wejść", type: "select", options: [{ value: "Ocalaly", label: "Ocalała" },{ value: "Original", label: "Pierwotna" }] },
      { key: "entry_uklad", label: "Układ liczby pozycji na szczeblach", type: "text", hint: "Liczba pozycji na kolejnych szczeblach, np. 1,2,1. Każda wartość 0–9; puste lub same zera zachowują domyślny układ." },
      { key: "entry_uklad_kotwica", label: "Kotwica układu wejść", type: "select", options: [{ value: "Ocalaly", label: "Ocalała" },{ value: "Original", label: "Pierwotna" }] },
      { key: "entry_warstwy_offset", label: "Przesunięcie warstw wejścia", type: "num", step: 0.1, when: (s) => s.entry_warstwy_z_tekstu },
      { key: "entry_warstwy_z_tekstu", label: "Czytaj warstwy wejścia z wiadomości", type: "bool" },
      { key: "fast_fill_layers", label: "Szybki fill: liczba warstw", type: "num", step: 1, min: 0 },
      { key: "fast_fill_reject_s", label: "Szybki fill: próg czasu odrzucenia", type: "num", step: 1, min: 0, unit: "s" },
      { key: "fast_fill_soft_age_min", label: "Szybki fill: miękki limit wieku", type: "num", step: 1, min: 0, unit: "min" },
      { key: "honor_stop_orders", label: "Respektuj jawne zlecenia STOP", type: "bool", hint: "Rozpoznany jawny STOP zachowuje typ STOP. Nie oznacza włączenia sygnałów rynkowych ani wyłączenia ochrony rachunku." },
      { key: "limit_kasuje_tylko_nadmiar", label: "Limit usuwa wyłącznie nadmiar", type: "bool" },
      { key: "market_entry_mode", label: "Sposób realizacji wejścia rynkowego", type: "select", hint: "Dotyczy wejść rynkowych. Nie określa ważności źródłowego sygnału LIMIT/STOP.", options: [{ value: "GridAtOnce", label: "Cała siatka naraz" },{ value: "Single", label: "Jedno wejście" },{ value: "Laddered", label: "Szczeblami" }] },
      { key: "pending_cross_policy", label: "Gdy rynek minął cenę pendingu", type: "select", options: [{ value: "Market", label: "Market" },{ value: "Stop", label: "Stop" },{ value: "Shift", label: "Przesuń" },{ value: "Skip", label: "Pomiń" }] },
      { key: "units_per_level_zone", label: "Licz jednostki na każdy poziom strefy", type: "bool" },
      { key: "zakaz_ponizej_krawedzi", label: "Blokuj wejścia poza krawędzią", type: "bool" },
  ] },

  {
    id: "engine_addons",
    title: "Dokładki, piramida i ponowne wejścia",
    desc: "Zaawansowane osie presetu. Edycja dotyczy wybranego presetu; pokaż pola zależne lub użyj wyszukiwania.",
    icon: "layers",
    category: "management",
    zakres: "preset",
    fields: [
      { key: "fast_addon_cooldown_s", label: "Dokładka impulsowa: odstęp", type: "num", step: 1, min: 0, unit: "s" },
      { key: "fast_addon_lot_mult", label: "Dokładka impulsowa: mnożnik lota", type: "num", step: 0.1, min: 0, unit: "×" },
      { key: "fast_addon_max", label: "Dokładka impulsowa: maksimum", type: "num", step: 1, min: 0 },
      { key: "fast_addon_min_stage", label: "Dokładka impulsowa: od etapu TP", type: "num", step: 1, min: 0 },
      { key: "fast_addon_move_usd", label: "Dokładka impulsowa: wymagany ruch", type: "num", step: 0.1 },
      { key: "fast_addon_window_s", label: "Dokładka impulsowa: okno ruchu", type: "num", step: 1, min: 0, unit: "s" },
      { key: "no_reenter_from_stage", label: "Zablokuj re-entry od etapu TP", type: "num", step: 1, min: 0 },
      { key: "pyramid_after_stage", label: "Piramida: od etapu TP", type: "num", step: 1, min: 0 },
      { key: "pyramid_lot_mult", label: "Piramida: mnożnik lota", type: "num", step: 0.1, min: 0, unit: "×" },
      { key: "pyramid_min_equity_mult", label: "Piramida: próg equity", type: "num", step: 0.1, min: 0, unit: "×" },
      { key: "pyramid_regime_lookback", label: "Piramida: okno reżimu", type: "num", step: 1, min: 0 },
      { key: "pyramid_regime_max_fast_pct", label: "Piramida: maks. udział szybkiego rynku", type: "num", step: 0.5, min: 0, unit: "%" },
      { key: "rearm_bez_pozycji", label: "Przezbrój koszyk bez pozycji", type: "bool" },
      { key: "rearm_bez_pozycji_max_h", label: "Przezbrojenie bez pozycji: wiek", type: "num", step: 1, min: 0, unit: "h" },
      { key: "reenter_min_return_s", label: "Re-entry: minimalny czas powrotu", type: "num", step: 1, min: 0, unit: "s" },
      { key: "reenter_respect_cap", label: "Re-entry respektuje limit", type: "bool" },
      { key: "reenter_stop_after_riskfree", label: "Zablokuj re-entry po RISK FREE", type: "bool" },
  ] },

  {
    id: "engine_small",
    title: "Progi małego kapitału",
    desc: "Zaawansowane osie presetu. Edycja dotyczy wybranego presetu; pokaż pola zależne lub użyj wyszukiwania.",
    icon: "wallet",
    category: "management",
    zakres: "preset",
    fields: [
      { key: "basket_max_age_min_small", label: "Maks. wiek koszyka: mały kapitał", type: "num", step: 0.1, when: (s) => s.basket_max_age_min_small_mult > 0 },
      { key: "basket_max_age_min_small_mult", label: "Próg kapitału: wiek koszyka", type: "num", hint: "Próg = kapitał startowy × mnożnik. 0 wyłącza wariant dla małego kapitału.", step: 0.1, min: 0, unit: "×" },
      { key: "entry_units_small", label: "Liczba wejść: mały kapitał", type: "num", step: 1, min: 0, when: (s) => s.entry_units_small_mult > 0 },
      { key: "entry_units_small_mult", label: "Próg kapitału: liczba wejść", type: "num", hint: "Próg = kapitał startowy × mnożnik. 0 wyłącza wariant dla małego kapitału.", step: 0.1, min: 0, unit: "×" },
      { key: "fast_fill_soft_age_min_small", label: "Szybki fill: wiek przy małym kapitale", type: "num", step: 0.1, when: (s) => s.fast_fill_soft_age_min_small_mult > 0 },
      { key: "fast_fill_soft_age_min_small_mult", label: "Próg kapitału: wiek szybkiego fillu", type: "num", hint: "Próg = kapitał startowy × mnożnik. 0 wyłącza wariant dla małego kapitału.", step: 0.1, min: 0, unit: "×" },
      { key: "market_entry_step_small", label: "Odstęp market: mały kapitał", type: "num", step: 0.1, when: (s) => s.market_entry_step_small_mult > 0 },
      { key: "market_entry_step_small_mult", label: "Próg kapitału: odstęp market", type: "num", hint: "Próg = kapitał startowy × mnożnik. 0 wyłącza wariant dla małego kapitału.", step: 0.1, min: 0, unit: "×" },
      { key: "max_open_baskets_small", label: "Maks. koszyki: mały kapitał", type: "num", step: 1, min: 0, when: (s) => s.max_open_baskets_small_mult > 0 },
      { key: "max_open_baskets_small_mult", label: "Próg kapitału: maks. koszyki", type: "num", hint: "Próg = kapitał startowy × mnożnik. 0 wyłącza wariant dla małego kapitału.", step: 0.1, min: 0, unit: "×" },
      { key: "max_open_positions_small", label: "Maks. pozycje: mały kapitał", type: "num", step: 1, min: 0, when: (s) => s.max_open_positions_small_mult > 0 },
      { key: "max_open_positions_small_mult", label: "Próg kapitału: maks. pozycje", type: "num", hint: "Próg = kapitał startowy × mnożnik. 0 wyłącza wariant dla małego kapitału.", step: 0.1, min: 0, unit: "×" },
      { key: "reenter_max_small", label: "Maks. re-entry: mały kapitał", type: "num", step: 1, min: 0, when: (s) => s.reenter_max_small_mult > 0 },
      { key: "reenter_max_small_mult", label: "Próg kapitału: maks. re-entry", type: "num", hint: "Próg = kapitał startowy × mnożnik. 0 wyłącza wariant dla małego kapitału.", step: 0.1, min: 0, unit: "×" },
      { key: "risk_per_basket_pct_small", label: "Ryzyko koszyka: mały kapitał", type: "num", step: 0.1, when: (s) => s.risk_per_basket_pct_small_mult > 0 },
      { key: "risk_per_basket_pct_small_mult", label: "Próg kapitału: ryzyko koszyka", type: "num", hint: "Próg = kapitał startowy × mnożnik. 0 wyłącza wariant dla małego kapitału.", step: 0.1, min: 0, unit: "×" },
      { key: "sl_min_dist_small", label: "Minimum SL: mały kapitał", type: "num", step: 0.1, when: (s) => s.sl_min_dist_small_mult > 0 },
      { key: "sl_min_dist_small_mult", label: "Próg kapitału: minimum SL", type: "num", hint: "Próg = kapitał startowy × mnożnik. 0 wyłącza wariant dla małego kapitału.", step: 0.1, min: 0, unit: "×" },
  ] },

  {
    id: "engine_regime",
    title: "Reżim i skalowanie zmiennością",
    desc: "Zaawansowane osie presetu. Edycja dotyczy wybranego presetu; pokaż pola zależne lub użyj wyszukiwania.",
    icon: "activity",
    category: "management",
    zakres: "preset",
    fields: [
      { key: "regime_cena", label: "Cena odniesienia reżimu", type: "select", options: [{ value: "Rynkowa", label: "Rynkowa" },{ value: "Wejscia", label: "Wejscia" },{ value: "Obie", label: "Obie" }] },
      { key: "regime_gdy_rozerwany", label: "Reżim: zachowanie przy rozbieżności", type: "select", options: [{ value: "Milcz", label: "Bez działania" },{ value: "KrotkieOkno", label: "KrotkieOkno" },{ value: "Miekko", label: "Miekko" }] },
      { key: "regime_miara", label: "Miara reżimu", type: "select", options: [{ value: "Srednia", label: "Średnia" },{ value: "Mediana", label: "Mediana" },{ value: "Kanal", label: "Kanal" },{ value: "Wykladnicza", label: "Wykladnicza" },{ value: "Percentyl", label: "Percentyl" }] },
      { key: "regime_okno2_h", label: "Drugie okno reżimu", type: "num", step: 1, min: 0, unit: "h" },
      { key: "regime_percentyl", label: "Percentyl reżimu", type: "num", step: 0.1 },
      { key: "regime_pilnuj_limitow", label: "Reżim pilnuje istniejących limitów", type: "bool" },
      { key: "regime_soft", label: "Miękka adaptacja reżimu", type: "bool" },
      { key: "regime_soft_lot_mult", label: "Miękki reżim: mnożnik lota", type: "num", step: 0.1, min: 0, unit: "×", when: (s) => s.regime_soft },
      { key: "regime_soft_max_positions", label: "Miękki reżim: maks. pozycji", type: "num", step: 1, min: 0, when: (s) => s.regime_soft },
      { key: "regime_soft_risk_mult", label: "Miękki reżim: mnożnik ryzyka", type: "num", step: 0.1, min: 0, unit: "×", when: (s) => s.regime_soft },
      { key: "regime_soft_units_mult", label: "Miękki reżim: mnożnik jednostek", type: "num", step: 0.1, min: 0, unit: "×", when: (s) => s.regime_soft },
      { key: "regime_strefa_martwa", label: "Martwa strefa reżimu", type: "num", step: 0.1 },
      { key: "regime_zmiennosc_max", label: "Reżim: maks. zmienność", type: "num", step: 0.1 },
      { key: "regime_zmiennosc_min", label: "Reżim: min. zmienność", type: "num", step: 1, min: 0, unit: "min" },
      { key: "vol_size_max_mult", label: "Zmienność: maks. mnożnik lota", type: "num", step: 0.1, min: 0, unit: "×", when: (s) => s.vol_size_mode !== "Off" },
      { key: "vol_size_min_mult", label: "Zmienność: min. mnożnik lota", type: "num", step: 0.1, min: 0, unit: "×", when: (s) => s.vol_size_mode !== "Off" },
      { key: "vol_size_mode", label: "Sposób skalowania zmiennością", type: "select", options: [{ value: "Off", label: "Wyłączone" },{ value: "Target", label: "Cel zmienności" },{ value: "Percentile", label: "Percentyl" }] },
      { key: "vol_size_odsezonuj", label: "Usuń sezonowość zmienności", type: "bool", when: (s) => s.vol_size_mode !== "Off" },
      { key: "vol_size_percentile_okno", label: "Okno percentyla wolumenu", type: "num", step: 1, min: 0, when: (s) => s.vol_size_mode !== "Off" },
      { key: "vol_size_target", label: "Docelowy zasięg zmienności", type: "num", step: 0.1, when: (s) => s.vol_size_mode !== "Off" },
  ] },

  {
    id: "engine_targets",
    title: "Cele, BE i prowadzenie runnera",
    desc: "Zaawansowane osie presetu. Edycja dotyczy wybranego presetu; pokaż pola zależne lub użyj wyszukiwania.",
    icon: "target",
    category: "management",
    zakres: "preset",
    fields: [
      { key: "be_min_pozycji", label: "BE: minimum pozycji", type: "num", step: 1, min: 0 },
      { key: "be_od_etapu", label: "BE: od etapu TP", type: "num", step: 1, min: 0 },
      { key: "cel_z_przeciwnego", label: "Cel z sygnału przeciwnego", type: "select", options: [{ value: "Off", label: "Wyłączone" },{ value: "DalszaKrawedz", label: "DalszaKrawedz" },{ value: "Srodek", label: "Srodek" }] },
      { key: "cel_z_przeciwnego_zapas", label: "Zapas celu przeciwnego", type: "num", step: 0.1 },
      { key: "cele_pomin_za_cena", label: "Pomijaj cele za bieżącą ceną", type: "bool" },
      { key: "no_tp_after_stage", label: "Usuń TP od etapu", type: "num", step: 1, min: 0 },
      { key: "oae_pod_woda", label: "OUT AT ENTRY przy stracie", type: "select", options: [{ value: "NicNieRob", label: "Bez działania" },{ value: "Zamknij", label: "Zamknij" },{ value: "DociagnijStop", label: "Dociągnij stop" }] },
      { key: "oae_skip_after_riskfree", label: "Pomiń OUT AT ENTRY po RISK FREE", type: "bool" },
      { key: "runner_cele_krok", label: "Runner: odstęp kolejnych celów", type: "num", step: 0.1 },
      { key: "runner_cele_n", label: "Runner: liczba kolejnych celów", type: "num", step: 1, min: 0 },
      { key: "runner_max_hold_rule_only", label: "Limit wieku runnera tylko z reguły", type: "bool" },
      { key: "runner_partial_pct", label: "Runner: częściowe zamknięcie", type: "num", step: 0.5, min: 0, unit: "%" },
      { key: "sl_po_tp1_na_krawedz", label: "Po TP1 przenieś SL na krawędź", type: "bool" },
      { key: "sl_wlasny_na_pozycje", label: "Własny SL każdej pozycji", type: "num", step: 0.1 },
      { key: "spp_arms_runner_clock", label: "SPP uzbraja zegar runnera", type: "bool" },
      { key: "spp_sl_mode", label: "SPP: sposób ustawienia SL", type: "select", options: [{ value: "Off", label: "Wyłączone" },{ value: "Stop", label: "Stop" },{ value: "OnlyIfBetter", label: "Tylko korzystniejszy SL" },{ value: "RunnersOnly", label: "Tylko runnery" },{ value: "RunnersOnlyIfBetter", label: "Runnery, tylko korzystniejszy SL" },{ value: "BankersOnly", label: "Tylko banki" }] },
      { key: "spp_sl_pad", label: "SPP: bufor stop-loss", type: "num", step: 0.1, when: (s) => s.spp_sl_mode !== "Off" },
      { key: "tp_drabinka_kotwica", label: "Kotwica drabinki celów", type: "select", options: [{ value: "Ocalaly", label: "Ocalała" },{ value: "Original", label: "Pierwotna" }] },
  ] },

  {
    id: "engine_sr",
    title: "Trailing S/R — parametry struktury",
    desc: "Zaawansowane osie presetu. Edycja dotyczy wybranego presetu; pokaż pola zależne lub użyj wyszukiwania.",
    icon: "chart",
    category: "management",
    zakres: "preset",
    fields: [
      { key: "trail_atr_mult", label: "Mnożnik ATR trailingu", type: "num", step: 0.1, min: 0, unit: "×" },
      { key: "trail_sr_atr_period", label: "S/R: okres ATR", type: "num", step: 1, min: 0, when: (s) => s.trail_sr_enabled },
      { key: "trail_sr_fractal_n", label: "S/R: szerokość fraktala", type: "num", hint: "Liczba świec potrzebna do potwierdzenia lokalnego ekstremum. Większa wartość opóźnia potwierdzenie struktury.", step: 1, min: 0, when: (s) => s.trail_sr_enabled },
      { key: "trail_sr_min_dist_tp", label: "S/R: min. dystans od TP", type: "num", step: 0.1, when: (s) => s.trail_sr_enabled },
      { key: "trail_sr_min_prominence_atr", label: "S/R: min. wyrazistość w ATR", type: "num", step: 0.1, when: (s) => s.trail_sr_enabled },
      { key: "trail_sr_offset", label: "S/R: stały bufor", type: "num", step: 0.1, when: (s) => s.trail_sr_enabled },
      { key: "trail_sr_offset_atr_mult", label: "S/R: bufor jako mnożnik ATR", type: "num", step: 0.1, min: 0, unit: "×", when: (s) => s.trail_sr_enabled },
      { key: "trail_sr_offset_spread_mult", label: "S/R: bufor jako mnożnik spreadu", type: "num", step: 0.1, min: 0, unit: "×", when: (s) => s.trail_sr_enabled },
      { key: "trail_sr_struct_window_h", label: "S/R: okno struktury", type: "num", step: 1, min: 0, unit: "h", when: (s) => s.trail_sr_enabled },
      { key: "trail_sr_tf_min", label: "S/R: interwał świec", type: "num", hint: "Interwał świec struktury S/R w minutach. Działa z włączonym trailingiem S/R.", step: 1, min: 0, unit: "min", when: (s) => s.trail_sr_enabled },
  ] },

  {
    id: "engine_messages",
    title: "Wiadomości — interpretacja i spójność",
    desc: "Zaawansowane osie presetu. Edycja dotyczy wybranego presetu; pokaż pola zależne lub użyj wyszukiwania.",
    icon: "signal",
    category: "management",
    zakres: "preset",
    fields: [
      { key: "hint_veto", label: "Wskazówka adresata może zawetować akcję", type: "bool" },
      { key: "live_tick_order_strict", label: "Ścisła kolejność ticków live", type: "bool" },
      { key: "parser_geometryczny", label: "Parser geometrii sygnału", type: "bool" },
      { key: "parser_luz_interpunkcyjny", label: "Toleruj warianty interpunkcji", type: "bool" },
      { key: "parser_min_pewnosc", label: "Minimum pewności parsera", type: "num", step: 0.1 },
      { key: "recap_guard", label: "Rozpoznawaj podsumowania transakcji", type: "bool" },
      { key: "reply_graph_transitive", label: "Śledź pośrednie odpowiedzi Telegrama", type: "bool" },
      { key: "rf_level_sanity_max_usd", label: "Maks. dystans poziomu RISK FREE", type: "num", step: 0.1 },
      { key: "sanity_tp_max", label: "Maksymalny dystans TP", type: "num", step: 0.1 },
      { key: "sanity_tp_rosnace", label: "Wymagaj uporządkowanej drabinki TP", type: "bool" },
      { key: "sanity_tp_strona", label: "Sprawdzaj stronę celów TP", type: "bool" },
      { key: "sanity_zone_max", label: "Maksymalna szerokość strefy", type: "num", step: 0.1 },
      { key: "sl_edit_reaches_pendings", label: "Edycja SL obejmuje pendingi", type: "bool" },
      { key: "sync_only_live_levels", label: "Synchronizuj tylko aktywne szczeble", type: "bool" },
      { key: "tp_correction_to_broker", label: "Przekazuj korektę TP do brokera", type: "bool" },
      { key: "tp_hit_match_level", label: "Dopasuj TP HIT do poziomu", type: "bool" },
      { key: "tp_unindexed_pips_require_price", label: "TP bez numeru wymaga potwierdzenia ceny", type: "bool" },
  ] },

  {
    id: "engine_ea",
    title: "Warstwa EA — kapitał i dokładki",
    desc: "Zaawansowane osie presetu. Edycja dotyczy wybranego presetu; pokaż pola zależne lub użyj wyszukiwania.",
    icon: "robot",
    category: "management",
    zakres: "preset",
    fields: [
      { key: "ea_lot_z_wolnego_marginesu", label: "EA: lot z wolnego marginesu", type: "num", step: 0.1, when: (s) => s.ea_enabled },
      { key: "ea_redukcja_przy_zageszczeniu", label: "EA: redukcja przy zagęszczeniu", type: "num", step: 0.1, when: (s) => s.ea_enabled },
      { key: "ea_stan_dnia", label: "EA: tryb stanu dnia", type: "select", options: [{ value: "Off", label: "Wyłączone" },{ value: "TylkoInkaso", label: "Tylko inkaso" }], when: (s) => s.ea_enabled },
      { key: "ea_stan_dnia_jednostki_mult", label: "EA: mnożnik jednostek po progu dnia", type: "num", step: 0.1, min: 0, unit: "×", when: (s) => s.ea_enabled },
      { key: "ea_stan_dnia_prog_sl", label: "EA: próg SL stanu dnia", type: "num", step: 1, min: 0, when: (s) => s.ea_enabled },
      { key: "ea_stop_dokladek_powrot", label: "EA: powrót po pauzie dokładek", type: "num", step: 0.1, when: (s) => s.ea_enabled },
      { key: "ea_stop_dokladek_przy_stracie", label: "EA: pauza dokładek przy stracie", type: "num", step: 0.1, when: (s) => s.ea_enabled },
      { key: "ea_zageszczenie_podloga", label: "EA: dolny próg zagęszczenia", type: "num", step: 0.1, when: (s) => s.ea_enabled },
  ] },

  {
    id: "engine_risk",
    title: "Ochrona — bramki i ekspozycja",
    desc: "Zaawansowane osie presetu. Edycja dotyczy wybranego presetu; pokaż pola zależne lub użyj wyszukiwania.",
    icon: "shield",
    category: "management",
    zakres: "preset",
    fields: [
      ...
      { key: "day_gate_od_salda", label: "Bramka dnia: dolna granica equity", type: "num", hint: "Equity z początku dnia musi być co najmniej równe tej wartości. 0 usuwa dolne ograniczenie.", step: 0.1 },
      { key: "exposure_bonus_baskets", label: "Dodatkowe koszyki po progu zysku", type: "num", step: 1, min: 0 },
      { key: "exposure_bonus_positions", label: "Dodatkowe pozycje po progu zysku", type: "num", step: 1, min: 0 },
      { key: "exposure_bonus_profit_pct", label: "Próg zysku dla dodatkowej ekspozycji", type: "num", step: 0.5, min: 0, unit: "%" },
      { key: "lot_max_z_salda", label: "Kapitał na 1 lot limitu zlecenia", type: "num", hint: "Limit pojedynczego zlecenia = podstawa kapitału / ta wartość. 0 wyłącza tę granicę. Wciąż obowiązują lot_max, budżet ryzyka i ograniczenia brokera.", step: 0.1 },
      { key: "sesja_bramka", label: "Miejsce działania bramki sesji", type: "select", options: [{ value: "Sygnal", label: "Sygnał" },{ value: "Wypelnienie", label: "Wypelnienie" },{ value: "Oba", label: "Oba" }] },
      { key: "zone_exit_adverse_close", label: "Zamknij po niekorzystnym wyjściu ze strefy", type: "bool" },
      { key: "zone_exit_adverse_s", label: "Niekorzystne wyjście ze strefy: czas", type: "num", step: 1, min: 0, unit: "s" },
  ] },

  {
    id: "engine_broker",
    title: "Rachunek — wykonanie i margines",
    desc: "Zaawansowane ustawienia wspólne dla rachunku. Nie zastępują specyfikacji symbolu otrzymanej od brokera.",
    icon: "activity",
    category: "general",
    zakres: "rachunek",
    fields: [
      { key: "lot_base", label: "Podstawa kapitału do lota", type: "select", hint: "Wspólna dla rachunku. Balance, equity lub mniejsza z obu wartości; odliczenie kredytu nadal wynika z ustawień bonusu.", options: [{ value: "Balance", label: "Saldo" }, { value: "Equity", label: "Equity" }, { value: "MinOfBoth", label: "Mniejsza z saldo / equity" }] },
      { key: "expo_cap_close", label: "Zamykaj po naruszeniu ekspozycji", type: "bool" },
      { key: "expo_cap_ml_pct", label: "Minimum margin level dla ekspozycji", type: "num", step: 0.5, min: 0, unit: "%" },
      { key: "expo_cap_pct", label: "Limit ekspozycji względem rachunku", type: "num", step: 0.5, min: 0, unit: "%" },
      { key: "expo_cap_s", label: "Interwał kontroli ekspozycji", type: "num", step: 1, min: 0, unit: "s" },
      { key: "sim_margin_at_market", label: "Symulacja: margines według rynku", type: "bool" },
      { key: "sim_margin_check_on_fill", label: "Symulacja: sprawdzaj margines przy fillu", type: "bool" },
      { key: "sim_validate_pending_stops", label: "Symulacja: waliduj stop poziomów pendingu", type: "bool" },
  ] },
];
