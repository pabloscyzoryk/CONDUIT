...
export interface Settings {
  ...
  lot_growth_mode: "Off" | "Power" | "ThresholdLinear" | "GeometricSteps";
  lot_growth_allocation: "Uniform" | "EqualSLRisk" | "Depth" | "EqualSLRiskDepth" | "ExposureAwareRisk";
  lot_growth_reference_lot: number;
  lot_growth_reference_balance: number;
  lot_growth_power: number;
  lot_growth_rate_pct: number;
  lot_growth_capital_multiple: number;
  lot_growth_lot_multiple: number;
  lot_growth_basket_risk_pct: number;
  lot_growth_equity_stress_strength: number;
  lot_growth_portfolio_load_strength: number;
  lot_growth_direction_load_strength: number;
  lot_growth_basket_count_strength: number;
  lot_growth_spread_stress_strength: number;
  lot_growth_tp1_deficit_strength: number;
  lot_growth_stop_width_strength: number;
  lot_growth_age_decay_strength: number;
  lot_growth_rearm_decay_strength: number;
  lot_growth_day_dd_strength: number;
