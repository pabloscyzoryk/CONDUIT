...
pub struct Settings {
    ...
    /// Opt-in nominal lot curve. Off retains the complete legacy sizing path.
    pub lot_growth_mode: crate::lot_growth::LotGrowthMode,
    pub lot_growth_allocation: crate::lot_growth::LotGrowthAllocation,
    /// Causal sizing attenuators. Zero disables an axis; strengths are 0..=2.
    pub lot_growth_equity_stress_strength: f64,
    pub lot_growth_portfolio_load_strength: f64,
    pub lot_growth_direction_load_strength: f64,
    pub lot_growth_basket_count_strength: f64,
    pub lot_growth_spread_stress_strength: f64,
    pub lot_growth_tp1_deficit_strength: f64,
    pub lot_growth_stop_width_strength: f64,
    pub lot_growth_age_decay_strength: f64,
    pub lot_growth_rearm_decay_strength: f64,
    pub lot_growth_day_dd_strength: f64,
    pub lot_growth_reference_lot: f64,
    pub lot_growth_reference_balance: f64,
    pub lot_growth_power: f64,
    pub lot_growth_rate_pct: f64,
    pub lot_growth_capital_multiple: f64,
    pub lot_growth_lot_multiple: f64,
    /// Current marked-to-stop budget of the entire basket before a new send.
    /// Zero disables this additional cap; it is not a continuous equity floor.
    pub lot_growth_basket_risk_pct: f64,
...
impl Default for Settings {
    fn default() -> Self {
        Settings {
            ...
            lot_percent: 1.0,
            lot_scale_step: 0.0,
            lot_growth_mode: crate::lot_growth::LotGrowthMode::Off,
            lot_growth_allocation: crate::lot_growth::LotGrowthAllocation::Uniform,
